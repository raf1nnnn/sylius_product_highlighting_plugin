(function ($) {
    ...
    $.fn.extend({
        productHighlightGenerator: function () {
            let timeout;
            $('[name*="dotit_product_highlighting"][name*="[name]"]').on('input', function() {
            ...
            $('.toggle-product_highlighting-slug-modification').on('click', function(e) {
                e.preventDefault();
...
(function($) {
    $(document).ready(function () {
        $(this).productHighlightGenerator();
    });
})(jQuery);
